...
public class LogParser {
    ...
    public static boolean equalHashMapRequest(ProtocolCommand c, Map<String, Object> map1, Map<String, Object> map2) {
        return switch (c) {
            ...
            case SIGN_OUT, DOMAINS_LIST, SIGN_OUT_OK, UPDATE_ANNONCE_OK, REMOVE_ANNONCE_OK, UDP_SERVER_OK -> true;
            case REQUEST_EXCHANGE_SERVER_PUBLIC_KEY_KO, SIGN_UP_KO, SIGN_IN_KO, CREATE_ANNONCE_KO, SIGN_OUT_KO, REMOVE_ANNONCE_KO, ANNONCE_FROM_DOMAIN_KO, UPDATE_ANNONCE_KO, DOMAINS_LIST_KO, UDP_SERVER_KO -> map1.get("Error").equals(map2.get("Error"));
            //case UDP_SERVER -> map1.get("Address").equals(map2.get("Address")) && (int) map1.get("Port") == (int) map2.get("Port");
            case UDP_SERVER -> map1.get("Address").equals(map2.get("Address"));
        };
    }
